...
This data goes over has information and ratings about shows and movies from that were streaming during March 2023. We will compare ratings, genres, and popularities of what was airing on various streaming platform during March 2023.
...
## Movies and Shows
We are going to look at how many shows and movies there are in the whole data set. Below we have comparisons of the percentages between platforms
```{r, echo=FALSE}
